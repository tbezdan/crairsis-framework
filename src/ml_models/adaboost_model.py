...
class AdaBoostModel(BaseModel):
    def __init__(self, random_seed=42, **kwargs):
        ...
        # Initialize AdaBoostRegressor with default parameters
        # Any parameters passed via kwargs will override AdaBoost's defaults
    ...
    def train(self, X_train, y_train, **kwargs):
        ...
        - kwargs: Additional arguments to pass to the AdaBoost fit method.
        """
        self.model.fit(X_train, y_train, **kwargs)

    def evaluate(self, X_test, y_test, **kwargs):
        """
        Evaluate the AdaBoost model on the given test dataset.

        Parameters:
        - X_test: Features of the test set.
        - y_test: True targets of the test set.
        - kwargs: Additional arguments to pass to the evaluation method of AdaBoost.
